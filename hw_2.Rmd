...
library(tidyverse)
```
1. You have just taken out a five-year loan from a bank to buy an engagement ring. The ring costs 7000. You plan to put down 1000 and borrow 6000. You will need to make annual payments of 1250 at the end of each year. Show the timeline of the loan from your perspective. How
would the timeline differ if you created it from the bank’s perspective?
```{r}
money_labs <- c(6000, rep(-1250, 5))
```
